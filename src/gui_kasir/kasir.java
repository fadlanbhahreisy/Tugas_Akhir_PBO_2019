...
public class kasir extends JFrame {
    public kasir(){
        ...
        JScrollPane skrol = new JScrollPane(struk);
        skrol.setBounds(350,130,400,400);
        kasir.add(skrol);
        ...
        check.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent ae){
                ...
                struk.setText("===struk pembayaran===\n"
                        ...
                        + "======= daftar barang ========"
                        +""+allobject.data_kasir.cetak(text_id.getText())
                        + "kembalian = "+allobject.data_kasir.kembalian(bayar, harga)+"\n"
                            + "======================");
                //allobject.data_kasir.cetak(text_id.getText());
                allobject.data_kasir.remove_transaksi(text_id.getText());
                text_id.setText("");
                text_bayar.setText("");
