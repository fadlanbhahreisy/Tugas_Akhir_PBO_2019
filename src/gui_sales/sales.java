...
public class sales extends JFrame {
    ...
    ArrayList <datastok> temp = new ArrayList<>(); ;
    public sales(){
    ...
    add.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent ae){
                ...
                allobject.pesanan.insert_pesanan(text_pembeli.getText(),nama_sales.getText(),id_regis.getText(), temp,temp.size());
...
//                JOptionPane.showMessageDialog(null,cetak,"Struk pembelian",JOptionPane.INFORMATION_MESSAGE);
                ...
                history_tabel.setModel(allobject.trans.viewhistory());
                    ...
                    JOptionPane.showMessageDialog(null,"eror","information",JOptionPane.INFORMATION_MESSAGE);
                }
            }
        });
